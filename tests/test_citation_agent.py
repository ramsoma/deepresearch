...
class TestCitationAgent(unittest.TestCase):
    ...
    def test_basic_citation_formatting(self):
        ...
        found = any(
            "John Doe" in ref and "Jane Smith" in ref and "2023" in ref and "Quantum Computing Advances" in ref and "https://example.com/quantum" in ref
    ...
    def test_missing_metadata(self):
        ...
        self.assertIn("[Unknown Author, " + str(self.current_year) + "]", result["content"])
        reference_list = result["reference_list"]
        self.assertIn("Unknown Author. " + str(self.current_year) + ". \"Incomplete Article.\" [No valid URL available]", reference_list)
    ...
    def test_multiple_citations(self):
        ...
        reference_list = result["reference_list"]
        self.assertIn("Alice Brown. 2022. \"First Article.\" [https://example.com/first](https://example.com/first)", reference_list)
        self.assertIn("Bob Wilson. 2023. \"Second Article.\" [https://example.com/second](https://example.com/second)", reference_list)
    ...
    def test_invalid_urls(self):
        ...
        reference_list = result["reference_list"]
        self.assertIn("Charlie Davis. 2023. \"Article with Bad URL.\" [No valid URL available]", reference_list)
    ...
    def test_citation_style_variants(self):
        ...
        # Test Chicago style
        chicago_result = self.citation_agent.forward(content, search_results, citation_style="chicago")
        self.assertRegex(chicago_result["content"], r"[\[(\(]David Lee(,| and)? 2023[\])\]]")
        
        # Test APA style
        apa_result = self.citation_agent.forward(content, search_results, citation_style="apa")
        self.assertRegex(apa_result["content"], r"[\[(\(]David Lee(,| and)? 2023[\])\]]")
    ...
    def test_duplicate_citations(self):
        ...
        reference_list = result["reference_list"]
        self.assertEqual(reference_list.count("Grace Hill. 2023. \"Repeated Article.\" [https://example.com/repeated](https://example.com/repeated)"), 1)
        ...
        search_results = [
            {
                ...
                "content": "Recent advances in quantum computing have shown promising results in solving complex problems."
            },
            {
                ...
                "content": "Error correction techniques are crucial for reliable quantum computing."
            },
            {
                ...
                "content": "Quantum computing applications span various fields including cryptography and optimization."
            }
        ]

        # Test content with multiple citations
        content = "Recent advances in quantum computing have shown promising results in solving complex problems, with error correction techniques being crucial for reliability. These applications span various fields including cryptography and optimization."

        # Process content
        result = self.citation_agent.forward(content, search_results, citation_style="chicago")
...
class TestLLMCitationAgent(unittest.TestCase):
    ...
    def test_citation_format(self, mock_generate_content):
        ...
        self.assertIn("Smith, Jones. 2023. \"Quantum Computing Advances.\" [URL](https://example.com/quantum)", result["references"])
        self.assertIn("Brown. 2024. \"Quantum Error Correction.\" [URL](https://example.com/error)", result["references"])
    ...
    def test_multiple_citations(self, mock_generate_content):
        ...
        mock_generate_content.return_value.text = (
            "Recent advances in quantum computing and error correction have shown promise. [Smith, Jones, 2023] [Brown, 2024]"
        )
        text = "Recent advances in quantum computing and error correction have shown promise."
    ...
    def test_no_sources(self, mock_generate_content):
        ...
        mock_generate_content.return_value.text = "Quantum computing is advancing rapidly.\n\n## References\n"
