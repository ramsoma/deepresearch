...
from deep_research_agent.evaluations.evaluators.research_evaluator import (  # noqa
    ResearchEvaluator,
)
...
def main():
    ...
    Quantum computing has made significant progress in recent years, with IBM
    achieving 433 qubits in their Osprey processor [IBM. (2022).
    IBM Quantum Roadmap.]. This represents a major milestone in the
    field's development. The technology shows promise for applications in
    cryptography and drug discovery [National Quantum Initiative. (2023).
    Quantum Applications Report.].
    ...
    Deploying AI models on edge devices presents unique challenges and opportunities.
    The primary considerations include model size optimization, power consumption,
    and real-time processing requirements [Qualcomm. (2023). Edge AI Deployment Guide.]
    Recent advances in model compression techniques have enabled more efficient
    deployment [Google. (2023). Efficient Edge AI Models.].
