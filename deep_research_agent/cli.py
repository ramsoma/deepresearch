...
def parse_args():
    ...
    parser.add_argument(
        "--depth", type=int, default=3, help="Maximum search depth (default: 3)"
    )
    parser.add_argument(
        "--results", type=int, default=5, help="Maximum results per search (default: 5)"
    )
    parser.add_argument(
        "--output",
        type=str,
...
def generate_report(args):
    ...
    logger.info(
        f"Sections with Citations: {citation_metrics.get('sections_with_citations', 0)}"
    )
