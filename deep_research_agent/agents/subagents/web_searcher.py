...
class WebSearcher(BaseAgent):
    ...
    def _perform_search(self, query: str, search_type: str = "basic") -> List[Dict[str, Any]]:
    ...
    def _refine_query(self, original_query: str, current_findings: List[Dict[str, Any]]) -> str:
